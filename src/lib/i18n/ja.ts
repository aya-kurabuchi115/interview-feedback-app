...
export const ja = {
  ...
  onboarding: {
    stepBasicInfo: "基本情報",
    stepPreferences: "志望情報",
    stepGoal: "目的選択",
    stepComplete: "完了",
    goalTitle: "今の就活状況は？",
    goalDescription: "あなたの状況に合わせて、最適な機能をご案内します。",
    goalInterview: "面接対策を始めたい",
    goalInterviewDesc: "面接の録音をAIが分析し、改善点を具体的にフィードバック",
    goalES: "ESを書いている",
    goalESDesc: "エントリーシートをAIが添削し、説得力のある文章に",
    goalSelfAnalysis: "自己分析をしたい",
    goalSelfAnalysisDesc: "16パーソナリティ診断で自分の強みと適性を発見",
    goalMock: "模擬面接で練習したい",
    goalMockDesc: "AIが面接官役となり、リアルな面接練習が可能",
    completeTitle: "セットアップ完了！",
    completeDescription: "プロフィールの設定が完了しました。さっそく始めましょう。",
    featureInterview: "面接分析",
    featureInterviewDesc: "面接を録音・スクリプト登録して、AIが回答内容と話し方を分析",
    featureMock: "AI模擬面接",
    featureMockDesc: "AIが面接官役となり、リアルな模擬面接を体験",
    featureES: "ES添削",
    featureESDesc: "エントリーシートをAIが分析・添削し、改善ポイントを提示",
    featurePersonality: "16パーソナリティ診断",
    featurePersonalityDesc: "性格タイプを診断し、自己PRや面接回答に活かす",
    recommendedForYou: "おすすめ",
    goToDashboard: "ダッシュボードへ",
    profileEditHint: "プロフィールはプロフィールページからいつでも変更できます。",
    gettingStarted: "はじめてガイド",
    gettingStartedDesc: "以下のステップを完了して、InterviewCoachを使いこなしましょう。",
    checkProfile: "プロフィールを設定する",
    checkInterview: "面接を分析する",
    checkMock: "模擬面接を体験する",
    checkPersonality: "パーソナリティ診断を受ける",
    checkES: "ES添削を利用する",
    progressLabel: "{completed}/{total} 完了",
    hideGuide: "ガイドを非表示",
    showGuide: "はじめてガイドを表示",
    tourWelcome: "InterviewCoachへようこそ！",
    tourWelcomeDesc: "主要な機能をご案内します。いつでもスキップできます。",
    tourDashboard: "ダッシュボード",
    tourDashboardDesc: "ここで面接履歴の確認や新規分析の開始ができます。",
    tourNewInterview: "新規面接を記録",
    tourNewInterviewDesc: "面接のスクリプトを登録すると、AIが内容を分析してフィードバックを生成します。",
    tourMockInterview: "AI模擬面接",
    tourMockInterviewDesc: "AIが面接官役となり、リアルタイムで模擬面接を行えます。",
    tourSkip: "スキップ",
    tourNext: "次へ",
    tourPrev: "前へ",
    tourFinish: "ツアーを終了",
